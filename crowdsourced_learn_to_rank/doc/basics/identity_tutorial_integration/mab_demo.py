...
# Add ltr-benchmarking to path
sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent / "ltr-benchmarking"))
...
async def start_mab_demo() -> None:
    ...
    for i, port in enumerate(ports, 1):
        ...
        builder.add_key("my peer", "medium", f"mab_peer{i}.pem")
